...
class TimeDimensionBuilder(object):
    ...
    def __init__(self):
        ...
        self._times = [start + datetime.timedelta(minutes=x) for x in range(0, 86400)]
...
class TimeRecord(object):
    ...
    def __init__(self, time):
        self.time_key = int(datetime.datetime.strftime(time, '%H%M%S'))/100
        ...
        self.military_time = datetime.datetime.strftime(time, '%H:%M')
    ...
    def columns():
        ...
        """
        return ['time_key', 'military_hour', 'civilian_hour', 'minute', 'am_pm', 'military_time', 'civilian_time', 'time_class']
